...
添加了ubuntu下自动重新连接wifi和vpn的功能

将整个代码修改得更加难以报错而终止运行，而是多次进行尝试

调整了一些小地方

由于原本是在1.3.1版本上进行的修改，而这边是直接我看了看进行合并的因此可能出现错误，请注意一下，可能需要自行调整，todo:标注了需要手动更改的地方，只要搜索todo出现的地方进行更改即可。

有什么问题或建议可以在issue中提出

由于本人绩点并不算低，用到的时间不多，并且这个代码是基于别人的更改的，因此维护上并不会很勤奋
